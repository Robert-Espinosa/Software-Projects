...
public final class PizzaOrderManager {
    ...
    public static void getPriceMap(String fileName,
        ...
        while (!read.atEOS()) {
            ...
            priceMap.add(nextLine.substring(0, nextLine.indexOf(',')),
                    Integer.parseInt(nextLine.substring(
                            nextLine.indexOf(',') + 1, nextLine.length())));
    ...
    public static int getOneOrder(SimpleReader input,
        ...
        while (!nextLine.isEmpty()) {
            price += toppingPriceMap.value(nextLine);
    ...
    public static void putPrice(SimpleWriter output, int price) {
        ...
        if (priceCents <= 9) {
            output.print("$" + priceDollars + ".0" + priceCents);
        } else {
            output.print("$" + priceDollars + "." + priceCents);
