 ...
 *
 */
public final class StackPalindrome {

    /**
     * Private constructor so this utility class cannot be instantiated.
     */
    private StackPalindrome() {
    }
     ...
     */
    private static boolean isPalindrome(Stack<Integer> s) {
        assert s != null : "Violation of: s is not null";

//        Sequence<Integer> copy = s.newInstance();
//        for (int i = 0; i < s.length(); i++) {
//            copy.add(i, s.entry(i));
//        }
