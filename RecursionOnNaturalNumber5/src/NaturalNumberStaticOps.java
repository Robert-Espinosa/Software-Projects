...
public final class NaturalNumberStaticOps {
    ...
    private static void printWithCommas(NaturalNumber n, SimpleWriter out) {
        ...
        NaturalNumber z = new NaturalNumber1L();
        z.copyFrom(n);
        if (n.compareTo(new NaturalNumber1L(1000)) < 0) {
            out.print(z);
        } else {
            int ones = z.divideBy10();
            int tens = z.divideBy10();
            int hundredes = z.divideBy10();
            printWithCommas(z, out);
            out.print("," + hundredes + tens + ones);
    ...
    private static String toStringWithCommas(NaturalNumber n) {
        ...
        if (z.compareTo(new NaturalNumber1L(1000)) < 0) {
            s = z + "";
        } else {
            int ones = z.divideBy10();
            int tens = z.divideBy10();
            int hundredes = z.divideBy10();
            s += toStringWithCommas(z);
            s += "," + +hundredes + tens + ones;
