...
public final class StringReassembly {
    ...
    public static String combination(String str1, String str2, int overlap) {
         ...
         */
        String overlaped = str1.substring(0, str1.length() - overlap) + str2;
    ...
    public static Set<String> linesFromInput(SimpleReader input) {
        ...
        Set<String> allLines = new Set1L<String>();

        //while there are more lines
        while (!input.atEOS()) {
            String next = input.nextLine();
            addToSetAvoidingSubstrings(allLines, next);
        }
    ...
    public static void printWithLineSeparators(String text, SimpleWriter out) {
        ...
        //go through all text and if there is ~ just do println else print
        //the charater at that postion
