...
public abstract class SequenceTest {
    ...
    @Test
    public void TestAdd() {
        Sequence<String> test = this.createFromArgsTest("1", "2");
        Sequence<String> expected = this.createFromArgsTest("1", "2", "3");
    ...
    */
    ...
    public void TestAdd2() {
        Sequence<String> test = this.createFromArgsTest("1", "2");
        Sequence<String> expected = this.createFromArgsTest("1", "5", "2");
